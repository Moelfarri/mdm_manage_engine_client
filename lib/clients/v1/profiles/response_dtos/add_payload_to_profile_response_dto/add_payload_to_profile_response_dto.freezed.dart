...
AddPayloadToProfileResponseDto _$AddPayloadToProfileResponseDtoFromJson(
    Map<String, dynamic> json) {
  return _AddPayloadToProfileResponseDto.fromJson(json);
}

/// @nodoc
mixin _$AddPayloadToProfileResponseDto {
  ...
  /// Serializes this AddPayloadToProfileResponseDto to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of AddPayloadToProfileResponseDto
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $AddPayloadToProfileResponseDtoCopyWith<AddPayloadToProfileResponseDto>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AddPayloadToProfileResponseDtoCopyWith<$Res> {
  factory $AddPayloadToProfileResponseDtoCopyWith(
          AddPayloadToProfileResponseDto value,
          $Res Function(AddPayloadToProfileResponseDto) then) =
      _$AddPayloadToProfileResponseDtoCopyWithImpl<$Res,
          AddPayloadToProfileResponseDto>;
  @useResult
  $Res call(
...
/// @nodoc
class _$AddPayloadToProfileResponseDtoCopyWithImpl<$Res,
        $Val extends AddPayloadToProfileResponseDto>
    implements $AddPayloadToProfileResponseDtoCopyWith<$Res> {
  _$AddPayloadToProfileResponseDtoCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$AddPayloadToProfileResponseDtoImplCopyWith<$Res>
    implements $AddPayloadToProfileResponseDtoCopyWith<$Res> {
  factory _$$AddPayloadToProfileResponseDtoImplCopyWith(
          _$AddPayloadToProfileResponseDtoImpl value,
          $Res Function(_$AddPayloadToProfileResponseDtoImpl) then) =
      __$$AddPayloadToProfileResponseDtoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'payload_id') int? payloadId,
...
/// @nodoc
class __$$AddPayloadToProfileResponseDtoImplCopyWithImpl<$Res>
    extends _$AddPayloadToProfileResponseDtoCopyWithImpl<$Res,
        _$AddPayloadToProfileResponseDtoImpl>
    implements _$$AddPayloadToProfileResponseDtoImplCopyWith<$Res> {
  __$$AddPayloadToProfileResponseDtoImplCopyWithImpl(
      _$AddPayloadToProfileResponseDtoImpl _value,
      $Res Function(_$AddPayloadToProfileResponseDtoImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$AddPayloadToProfileResponseDtoImpl(
      payloadId: freezed == payloadId
          ? _value.payloadId
          : payloadId // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$AddPayloadToProfileResponseDtoImpl
    implements _AddPayloadToProfileResponseDto {
  _$AddPayloadToProfileResponseDtoImpl(
  ...
  factory _$AddPayloadToProfileResponseDtoImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$AddPayloadToProfileResponseDtoImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AddPayloadToProfileResponseDtoImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AddPayloadToProfileResponseDtoImplCopyWith<
          _$AddPayloadToProfileResponseDtoImpl>
      get copyWith => __$$AddPayloadToProfileResponseDtoImplCopyWithImpl<
          _$AddPayloadToProfileResponseDtoImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$AddPayloadToProfileResponseDtoImplToJson(
      this,
    );
  }
}

abstract class _AddPayloadToProfileResponseDto
    implements AddPayloadToProfileResponseDto {
  factory _AddPayloadToProfileResponseDto(
      {@JsonKey(name: 'payload_id') final int? payloadId,
      ...
      @JsonKey(name: 'max_grace_period')
      final int? maxGracePeriod}) = _$AddPayloadToProfileResponseDtoImpl;

  factory _AddPayloadToProfileResponseDto.fromJson(Map<String, dynamic> json) =
      _$AddPayloadToProfileResponseDtoImpl.fromJson;
