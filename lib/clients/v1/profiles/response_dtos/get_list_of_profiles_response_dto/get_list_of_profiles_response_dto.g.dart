...
_$GetListOfProfilesResponseDtoImpl _$$GetListOfProfilesResponseDtoImplFromJson(
        Map<String, dynamic> json) =>
    _$GetListOfProfilesResponseDtoImpl(
      profiles: (json['profiles'] as List<dynamic>?)
          ?.map((e) => GetListOfProfilesResponseDtoProfiles.fromJson(
              e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$$GetListOfProfilesResponseDtoImplToJson(
        _$GetListOfProfilesResponseDtoImpl instance) =>
    <String, dynamic>{
      'profiles': instance.profiles,
    };

_$GetListOfProfilesResponseDtoProfilesImpl
    _$$GetListOfProfilesResponseDtoProfilesImplFromJson(
            Map<String, dynamic> json) =>
        _$GetListOfProfilesResponseDtoProfilesImpl(
...
Map<String, dynamic> _$$GetListOfProfilesResponseDtoProfilesImplToJson(
        _$GetListOfProfilesResponseDtoProfilesImpl instance) =>
    <String, dynamic>{
