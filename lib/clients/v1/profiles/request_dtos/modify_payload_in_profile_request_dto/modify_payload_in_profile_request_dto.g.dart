...
_$ModifyPayloadInProfileRequestDtoImpl
    _$$ModifyPayloadInProfileRequestDtoImplFromJson(
...
Map<String, dynamic> _$$ModifyPayloadInProfileRequestDtoImplToJson(
        _$ModifyPayloadInProfileRequestDtoImpl instance) =>
    <String, dynamic>{
